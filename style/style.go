...
type Style struct {
	...
	ClearColor           *string                `json:"flywave:clearColor,omitempty"`
	ClearAlpha           *int                   `json:"flywave:clearAlpha,omitempty"`
	EnableShadows        *bool                  `json:"flywave:enableShadows,omitempty"`
	ToneMappingExposure  *float64               `json:"flywave:toneMappingExposure,omitempty"`
	FlywaveDefinitions   *FlywaveDefinitions    `json:"flywave:definitions,omitempty"`
	FlywavePostEffects   *FlywavePostEffects    `json:"flywave:postEffects,omitempty"`
	FlywaveTextStyles    []FlywaveTextStyle     `json:"flywave:textStyles,omitempty"`
	FlywaveFontCatalogs  []FlywaveFontCatalog   `json:"flywave:fontCatalogs,omitempty"`
	FlywaveImageTextures []FlywaveImageTexture  `json:"flywave:imageTextures,omitempty"`
	FlywavePoiTables     []FlywavePoiTableRef   `json:"flywave:poiTables,omitempty"`
	FlywavePriorities    []FlywavePriority      `json:"flywave:priorities,omitempty"`
	FlywaveLabelPriorities []string              `json:"flywave:labelPriorities,omitempty"`
